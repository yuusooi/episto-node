...
class EpistoState(TypedDict):
    ...
    Fields:
        ...
        grading_data: Structured grading results from the Grader sub-agent.
            Contains results, score, and feedback. Last-writer-wins.
    """
    ...
    grading_data: NotRequired[dict | None]
